    ...
    <section className="mb-32">
      <div id="map" className="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat">
        <iframe
          ...
          height="480"
          style={{ border: 0 }}
          src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d2483.678149806689!2d-2.5483847470284373!3d51.500773468006514!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sfr!2sus!4v1710939689370!5m2!1sfr!2sus"
          allowFullScreen=""
          loading="lazy"
          ...
          <div className="flex flex-wrap">
            ...
            >
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <button
                  type="submit"
                  className="mb-6 w-full rounded bg-blue-700 text-white px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal lg:mb-0"
                >
                  Send
                </button>
              </form>
